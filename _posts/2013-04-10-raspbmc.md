...
<amp-img src="{{ IMG_PATH }}raspberry-pi.jpg" alt="Raspberry Pi" style="float:right;" width="300" height="377" layout="responsive">
...
<amp-img src="{{ IMG_PATH }}raspbmc-remote.png" alt="Raspbmc Remote" style="float:right;" width="200" height="300" layout="responsive">
