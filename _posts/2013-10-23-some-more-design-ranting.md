...
<ol>
  ...
  <li>
    <div class="right10">
      <amp-img src="{{ IMG_PATH }}bad-ui-register-vs-signin.png" alt="Bad UI: Register vs Sign In confusion" width="640" height="960" layout="responsive"></amp-img>
    </div>
  ...
  <li>
    <div class="right10">
      <amp-img src="{{ IMG_PATH }}bad-ui-contact-management.png" alt="Bad UI: Contact management" width="640" height="960" layout="responsive"></amp-img>
    </div>
