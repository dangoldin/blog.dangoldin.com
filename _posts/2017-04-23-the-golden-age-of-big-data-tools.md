...
description: "We're collecting so much data at a low enough price point that there's a massive proliferation in open source tools to help get it under control. It's the golden age of big data tools."
keywords: "big data, real time stream processing, batch processing, kafka, hadoop, spark, storm"
image_url: "/assets/static/images/big-data-growth.png"
category:
tags: ["#data"]
---
{% include setup %}
